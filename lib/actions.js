...
exports.onBeforeRequest = function(cb, options, done) {
  debug('.onBeforeRequest()');
  this.child.on('intercept', cb);
  this.child.call('intercept', options.filter, options.cancel);
  done();
};
